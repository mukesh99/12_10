...
//------------------------------------------------------
 ...
 function showData(scanInfo){
		...
		var tableHeadingAMP = '<tr>';
			tableHeadingAMP += '<td colspan="10"><h3>' + scan_name + '</h3></td>';
			tableHeadingAMP += '</tr>';
		 
			tableHeadingAMP += '<tr>';
			tableHeadingAMP += '<th>Symbol</th>';
			tableHeadingAMP += '<th>Open</th>';
			tableHeadingAMP += '<th>Low</th>';
			tableHeadingAMP += '<th>High</th>';
			tableHeadingAMP += '<th>LtP</th>';
			tableHeadingAMP += '<th>ATP</th>';
			tableHeadingAMP += '<th>Volume</th>';
			tableHeadingAMP += '<th>Auto</th>';
			/* tableHeadingAMP += '<th>RCL</th>';
			tableHeadingAMP += '<th>RCLX</th>';
			tableHeadingAMP += '<th>RCLB</th>';
			tableHeadingAMP += '<th>RCLXB</th>';
			tableHeadingAMP += '<th>CLPU</th>';
			tableHeadingAMP += '<th>CLPD</th>';
			tableHeadingAMP += '<th>EH</th>';
			tableHeadingAMP += '<th>EL</th>'; */
			tableHeadingAMP += '<th>Entry Point</th>';
			tableHeadingAMP += '<th>Stop Loss</th>';
			tableHeadingAMP += '<th>On Going</th>';
			tableHeadingAMP += '<th>&nbsp;</th>';
			
			/*tableHeadingAMP += '<th>cAct</th>';
			tableHeadingAMP += '<th>yPC</th>';
			tableHeadingAMP += '<th>mPC</th>'; */
			tableHeadingAMP += '</tr>';
		
		itemsAMP.push(tableHeadingAMP);
		 ...
		 for(var i = 0; i < maindata.length; i++)
		 {
			...
			if(sel_type != ''){
				...
				{
					if(sel_filter_2 != '' && sel_operator_2 != '' && sel_filter2_2 != '')
					{
						if(sel_filter_3 != '' && sel_operator_3 != '' && sel_filter2_3 != '')
						{
							if( second_sel_filter != '' && second_sel_operator != '' && second_sel_filter2 != '' && second_sel_filter_four != '' && second_sel_operator_five != '' && second_sel_filter_six != '')  
							{
								...
								if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' && third_sel_filter_four != '' && third_sel_operator_five != '' && third_sel_filter_six != '')
								{
									...
									if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
											canPush = true;
										}
									}
									else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3]))&& eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
											canPush = true;
										}
									}
									else
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) ){
											canPush = true;
										}	
									}
								...
								else if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' )
								{
									...
									if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
											canPush = true;
										}
									}
									else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
											canPush = true;
										}
									}
									else
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2]))){
											canPush = true;
										}	
									}
								...
								else
								{
									...
									if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) ){
										canPush = true;
									}
								}
							...
							{	
								if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' && third_sel_filter_four != '' && third_sel_operator_five != '' && third_sel_filter_six != '')  
								{
									...
									if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
											canPush = true;
										}
									}
									else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
											canPush = true;
										}
									}
									else
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) ){
											canPush = true;
										}
									}
								...
								else if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' )
								{
									...
									if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
											canPush = true;
										}
									}
									else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
									{
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
											canPush = true;
										}
									}
									else
									{
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) ){
											canPush = true;
										}
									}
								...
								{
									if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) ){
										canPush = true;
									}
								}
							...
							{ 
								if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][sel_filter_3]) + sel_operator_3 + pureNum(maindata[i][sel_filter2_3])) ){
									canPush = true;
								}
							}
						}
								...
								if( second_sel_filter != '' && second_sel_operator != '' && second_sel_filter2 != '' && second_sel_filter_four != '' && second_sel_operator_five != '' && second_sel_filter_six != '')  
								{
									...
									if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' && third_sel_filter_four != '' && third_sel_operator_five != '' && third_sel_filter_six != '')
									{
										...
										if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
												canPush = true;
											}
										}
										else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
												canPush = true;
											}
										}
										else
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) ){
												canPush = true;
											}	
										}
									...
									else if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' )
									{
										...
										if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
												canPush = true;
											}
										}
										else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
												canPush = true;
											}
										}
										else
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2]))){
												canPush = true;
											}	
										}
									...
									else
									{
										...
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + ur_percent) ){
											canPush = true;
										}
									}
								...
								{	
									if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' && third_sel_filter_four != '' && third_sel_operator_five != '' && third_sel_filter_six != '')  
									{
										...
										if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
												canPush = true;
											}
										}
										else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
												canPush = true;
											}
										}
										else
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + ur_percent_2) ){
												canPush = true;
											}
										}
									...
									else if( third_sel_filter != '' && third_sel_operator != '' && third_sel_filter2 != '' )
									{
										...
										if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' && fourth_sel_filter_four != '' && fourth_sel_operator_five != '' && fourth_sel_filter_six != '')
										{
											...
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + ur_percent_3) ){
												canPush = true;
											}
										}
										else if( fourth_sel_filter != '' && fourth_sel_operator != '' && fourth_sel_filter2 != '' )
										{
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) && eval(pureNum(maindata[i][fourth_sel_filter]) + fourth_sel_operator + pureNum(maindata[i][fourth_sel_filter2])) ){
												canPush = true;
											}
										}
										else
										{
											if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) && eval(pureNum(maindata[i][third_sel_filter]) + third_sel_operator + pureNum(maindata[i][third_sel_filter2])) ){
												canPush = true;
											}
										}
									...
									{
										if( sel_type == maindata[i]['auto'] && eval(pureNum(maindata[i][sel_filter]) + sel_operator + pureNum(maindata[i][sel_filter2])) && eval(pureNum(maindata[i][sel_filter_2]) + sel_operator_2 + pureNum(maindata[i][sel_filter2_2])) && eval(pureNum(maindata[i][second_sel_filter]) + second_sel_operator + pureNum(maindata[i][second_sel_filter2])) ){
											canPush = true;
										}
									}
				...
				if(canPush){
					...
					itemsAMP.push(getRowDataAMP(i, scanInfo));
				}
			}
			else 
			{
						...
						/*   items.push( "<td class='RCL'>" 	+ maindata[i]['RCL'] + "</td>" );
						 ...
						 itemsAMP.push( "<td class='symbol'>" 	+ maindata[i]['symbol'] + "</td>" );
						 itemsAMP.push( "<td class='open'>" 	+ maindata[i]['open'] 	+ "</td>" );
						 itemsAMP.push( "<td class='low'>" 	+ maindata[i]['low'] 	+ "</td>" );
						 itemsAMP.push( "<td class='high'>" 	+ maindata[i]['high'] 	+ "</td>" );
						 itemsAMP.push( "<td class='ltP'>" 	+ maindata[i]['ltP'] 	+ "</td>" );
						 itemsAMP.push( "<td class='ATP'>" 	+ maindata[i]['ATP'] 	+ "</td>" );
						  itemsAMP.push( "<td class='Volume'>" + maindata[i]['low'] + "</td>" );
						  itemsAMP.push( "<td class='Auto'>" 	+ maindata[i]['auto'] 	+ "</td>" );
						/*   itemsAMP.push( "<td class='RCL'>" 	+ maindata[i]['RCL'] + "</td>" );
						  itemsAMP.push( "<td class='RCLX'>" 	+ maindata[i]['RCLX'] 	+ "</td>" );
						  itemsAMP.push( "<td class='RCLB'>" 	+ maindata[i]['RCLB'] 	+ "</td>" );
						  itemsAMP.push( "<td class='RCLXB'>" 	+ maindata[i]['RCLXB'] 	+ "</td>" );
						  itemsAMP.push( "<td class='CLPU'>" 	+ maindata[i]['CLPU'] 	+ "</td>" );
						  itemsAMP.push( "<td class='CLPD'>" 	+ maindata[i]['CLPD'] 	+ "</td>" );
						  itemsAMP.push( "<td class='EH'>" 	+ maindata[i]['EH'] 	+ "</td>" );
						  itemsAMP.push( "<td class='EL'>" 	+ maindata[i]['EL'] 	+ "</td>" ); */
						 
						 itemsAMP.push('</tr>'); 
			}
		 }
		  
		 $('#tableContent, #tableContentAMP').html('');
 ...
 function getRowDataAMP(a, scanInfo){
	var maindata = MyData.data;
